...
Просто загугли **"(марка вашего телефона) USB drivers"**, скачай и установи их.
...
После завершения установки можно наконец-то **oxygenlink**. 

При использовании oxygenlink устройство должно быть **всегда** подключено к ПК, иначе **scrcpy** не сможет стримить приложения.

#### Важно!
* После первого запуска **oxygenlink** прога будет тащить иконки приложений с устройства. Это займет 5-10 минут.
