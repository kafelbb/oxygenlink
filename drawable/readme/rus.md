# oxygenlink
  ## ⚠ Проект большк не ведется активно. Также был обнаружен баг с устройствами на MediaTek, превращающий все иконки в квадраты рандомных цветов
### [ English ](../../README.md)
...
4. Создай ярлык на программу и закинь его на рабочий стол
...
1. Скачай другую версию на странице [Releases](https://github.com)
...
> К слову происходит это из-за того, что Android Debug Bridge (ADB), который использует прога для подключения к телефону, запускается как daemon-server, чтобы любая другая прога, которая хочет выполнить команду через ADB, могла это сделать быстро, а не ждать долгой инициализации ADB. По этому ADB остается работать на фоне и не дает удалить папку
